...
int main()
{
    ...
    }
    {
        ...
        const KeyValue keyValue = {"Key"};
        const KeyValue keyValue1 = {"Ke1"};
        const KeyValue keyValue2 = {"Ke2"};
        const KeyValue keyValue3 = {"Ke3"};
        const KeyValue keyValue4 = {"Ke4"};
        const KeyValue keyValue5 = {"Ke5"};
        set = set_init(set, sizeof(KeyValue), hash, equals, NULL);
