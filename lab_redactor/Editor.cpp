...
void Editor::insertLines(unsigned long pos, const std::string &additionalText) {
    ...
    paragraphs.insert(paragraphs.begin() + pos,
                      additionalParagraphs.begin(), additionalParagraphs.end());
}
...
void Editor::replaceLines(unsigned long start, unsigned long finish, const std::string &oldText,
