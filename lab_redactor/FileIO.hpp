...
public:
    ...
    [[nodiscard]] inline std::string getFirstInputName() const {
        return TextFileName;
    }

    [[nodiscard]] inline std::string getSecondInputName() const {
        return Recipe;
    }

    [[nodiscard]] inline std::string getOutputName() const {
